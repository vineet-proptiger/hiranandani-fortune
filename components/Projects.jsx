  ...
  return (
    <section id="projects" className="projects-section">
      ...
      <div className="container mx-auto px-4 sm:px-8 max-w-[1300px] relative z-10">
        ...
        {/* Project 1: Hiranandani Fortune City Residential */}
        <div className="project-card-wrap flex flex-col lg:flex-row" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
          ...
          <div className="w-full lg:w-1/2 project-img-container">
            <Image
              ...
              alt="Hiranandani Fortune City - Residential Towers"
              width={700}
              height={550}
        ...
        {/* Project 2: Hiranandani Business Park & Commercial */}
        <div className="project-card-wrap flex flex-col lg:flex-row-reverse mb-0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          ...
          <div className="w-full lg:w-1/2 project-img-container">
            <Image
              ...
              alt="Hiranandani Fortune City - Commercial & Business Park"
              width={700}
              height={550}
              className="project-img"
              priority={true}
          ...
          <div className="w-full lg:w-1/2 project-content-box">
            <h3 className="project-title">HIRANANDANI BUSINESS PARK</h3>
            <p className="project-desc">
              Complementing the luxury residences is the landmark Hiranandani Business Park and retail sector, offering state-of-the-art office spaces and lively retail boulevards. Thoughtfully planned as an integrated township, it exemplifies the Live, Work, and Play concept with grand entrance lobbies, multi-level parking, bustling commercial shopping centers, and seamless connectivity to Panvel Station and expressways.
            </p>
            <button
              className="explore-btn"
              onClick={() => setIsOpen && setIsOpen(true)}
