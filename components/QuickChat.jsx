        ...
        <div className="bg-[#e7e1d5] rounded-2xl overflow-hidden shadow-lg border border-black/5">
          ...
          <div className="bg-[#005B4F] text-white px-3 py-2.5 sm:px-4 sm:py-3 flex items-center">
            ...
            <div className="ml-3 flex flex-col">
              <strong className="text-[14px] sm:text-[15px] font-semibold leading-tight">Hiranandani Fortune City</strong>
          ...
          <div className="p-3 sm:p-5 flex flex-col gap-3 sm:gap-4">
            <div className="bg-white text-[#151515] text-[13px] sm:text-[14px] px-3 py-2.5 sm:px-4 sm:py-3 rounded-2xl rounded-tl-sm w-fit shadow-sm max-w-[85%] self-start">
              Hi 👋 What would you like to know about Hiranandani Fortune City?
            </div>
            
            <div className="flex flex-wrap justify-start gap-1.5 sm:gap-2.5">
              {[
                {text: "💰 Current price band", link: "https://wa.me/919718344024?text=Hi%2C%20I%20want%20the%20current%20price%20band%20for%20Hiranandani%20Fortune%20City%20Panvel."},
                {text: "📄 2, 3 & 4 BHK floor plans", link: "https://wa.me/919718344024?text=Hi%2C%20please%20send%20me%20the%202%2C%203%20and%204%20BHK%20floor%20plans%20for%20Hiranandani%20Fortune%20City."},
                {text: "🚗 Book a site visit", link: "https://wa.me/919718344024?text=Hi%2C%20I%20want%20to%20book%20a%20site%20visit%20for%20Hiranandani%20Fortune%20City%20Panvel."},
                {text: "🌍 NRI investment guide", link: "https://wa.me/919718344024?text=Hi%2C%20I%20am%20an%20NRI%20buyer%20%E2%80%94%20please%20share%20the%20Hiranandani%20Fortune%20City%20NRI%20investment%20guide."},
                {text: "📐 Payment plan", link: "https://wa.me/919718344024?text=Hi%2C%20please%20share%20the%20Hiranandani%20Fortune%20City%2010%3A20%3A70%20payment%20plan%20and%20schedule."},
                {text: "📄 Send brochure (PDF)", link: "https://wa.me/919718344024?text=Hi%2C%20please%20share%20the%20Hiranandani%20Fortune%20City%20brochure%20and%20official%20PDF."},
                {text: "📞 Request a callback", link: "https://wa.me/919718344024?text=Hi%2C%20please%20schedule%20a%20callback%20for%20Hiranandani%20Fortune%20City%20Panvel."}
              ].map((pill, i) => (
